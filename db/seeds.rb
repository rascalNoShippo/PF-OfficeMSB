...
message[1].user_name = user[12].name
message[1].save
...
message[1].comments.create(comment_id: message[1].number_of_comments, commenter_id: user[2].id, commenter_name: user[2].name, body: "<p>大阪支店<br>承知致しました。</p>", created_at: Time.new(2022, 11, 2, 10, 5, 0, "+09:00"))
message[1].update(number_of_comments: message[1].number_of_comments + 1)
message[1].comments.create(comment_id: message[1].number_of_comments, commenter_id: user[6].id, commenter_name: user[6].name, body: "<p>東京支店<br>承知致しました。</p>", created_at: Time.new(2022, 11, 2, 14, 25, 0, "+09:00"))
message[1].update(number_of_comments: message[1].number_of_comments + 1)
message[1].comments.create(comment_id: message[1].number_of_comments, commenter_id: user[1].id, commenter_name: user[1].name, body: "<p>情報システム部<br>承知致しました。</p>", created_at: Time.new(2022, 11, 2, 15, 0, 0, "+09:00"))
message[1].update(number_of_comments: message[1].number_of_comments + 1)
comment = message[1].comments.create(comment_id: message[1].number_of_comments, commenter_id: user[10].id, commenter_name: user[10].name, body: "<p>人事部<br>承知致しました。</p>", created_at: Time.new(2022, 11, 3, 9, 47, 0, "+09:00"))
...
message[2].update(number_of_comments: message[2].number_of_comments + 1)
comment = message[2].comments.create(comment_id: message[2].number_of_comments, commenter_id: user[4].id, commenter_name: user[4].name, body: '<p><span style="font-size: 24px;"><b style=""><font color="#ff9c00">有難う御座います！</font></b></span><br></p>', created_at: Time.new(2022, 9, 1, 10, 27, 30, "+09:00"))
...
message[3].update(number_of_comments: message[3].number_of_comments + 1)
comment = message[3].comments.create(comment_id: message[3].number_of_comments, commenter_id: user[2].id, commenter_name: user[2].name, body: '<p>提出致します。<br>ご確認のほど宜しくお願い致します。</p>', created_at: Time.new(2022, 11, 27, 17, 1, 20, "+09:00"))
...
article[3].user_name = user[1].name
...
article[4].user_name = user[1].name
